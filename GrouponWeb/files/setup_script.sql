...
-- password: 123456
insert into user (id, email, username, name, surname, password, rating, create_date, update_date) values (1, 'admin@admin.com', 'admin', 'admin', 'admin', '85bce29c3868a29d04b7e62f1c0451b0', 1000000, sysdate(), sysdate());
